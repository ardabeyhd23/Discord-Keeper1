...
let shopState: ShopState = { users: {}, orders: [], lastCampaignAt: {}, campaignDiscount: {}, campaignExpiresAt: {}, shopCatalog: {} };
...
async function handleShopSlash(interaction: JsonRecord, guildId: string): Promise<void> {
  ...
  // /shop yalnızca herkese açık mağaza giriş mesajını yeniler.
  // Bakiye ve alışveriş ekranı butona basan kişiye özel (ephemeral) açılır.
  await sendMessage(String(channel.id), {
