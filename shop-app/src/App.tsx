...
export default function App() {
  ...
  return <main className="app-shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-category-title">KATEGORİLER</div>
    ...
    <header className="topbar">
      ...
      <label className="top-search">⌕<input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Ürün ara..." /><kbd>⌘ K</kbd></label>
